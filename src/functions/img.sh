_show() {
  ...
  # #region agent log
  echo "{\"id\":\"log_$(date +%s)_img1\",\"timestamp\":$(date +%s)000,\"location\":\"img.sh:34\",\"message\":\"Before kitty command\",\"data\":{\"img_path\":\"$img_path\"},\"sessionId\":\"debug-session\",\"runId\":\"post-fix\",\"hypothesisId\":\"C\"}" >> /Users/taylor/dotfiles/.cursor/debug.log
  # #endregion agent log
  ...
  echo "{\"id\":\"log_$(date +%s)_img2\",\"timestamp\":$(date +%s)000,\"location\":\"img.sh:35\",\"message\":\"After kitty command\",\"data\":{\"exit_code\":$kitty_exit_code,\"stderr\":\"$kitty_error\"},\"sessionId\":\"debug-session\",\"runId\":\"post-fix\",\"hypothesisId\":\"C\"}" >> /Users/taylor/dotfiles/.cursor/debug.log
  # #endregion agent log
  rm -f "$kitty_stderr"
