...
spotlight_select_action () {
  ...
  echo
  printf '1) setup     %s|%s %sspot%s %ssetup%s\n'    "$pipe" "$reset" "$primary" "$reset" "$secondary" "$reset"
  printf '             %s|%s %sspot%s %ssuppress%s\n'  "$pipe" "$reset" "$primary" "$reset" "$secondary" "$reset"
  printf '             %s|%s %sspot%s %ss%s\n'         "$pipe" "$reset" "$primary" "$reset" "$secondary" "$reset"

  printf '2) add       %s|%s %sspot%s %sadd%s\n'      "$pipe" "$reset" "$primary" "$reset" "$secondary" "$reset"
  printf '             %s|%s %sspot%s %sa%s\n'        "$pipe" "$reset" "$primary" "$reset" "$secondary" "$reset"
  printf '             %s|%s %sspot%s %shush%s\n'     "$pipe" "$reset" "$primary" "$reset" "$secondary" "$reset"
  printf '             %s|%s %sspot%s %sh%s\n'        "$pipe" "$reset" "$primary" "$reset" "$secondary" "$reset"

  printf '3) clean     %s|%s %sspot%s %sclean%s\n'    "$pipe" "$reset" "$primary" "$reset" "$secondary" "$reset"
  printf '             %s|%s %sspot%s %sc%s\n'        "$pipe" "$reset" "$primary" "$reset" "$secondary" "$reset"

  printf '4) list      %s|%s %sspot%s %slist%s\n'     "$pipe" "$reset" "$primary" "$reset" "$secondary" "$reset"
  printf '             %s|%s %sspot%s %sls%s\n'       "$pipe" "$reset" "$primary" "$reset" "$secondary" "$reset"
  printf '             %s|%s %sspot%s %sl%s\n'        "$pipe" "$reset" "$primary" "$reset" "$secondary" "$reset"

  printf '5) watch     %s|%s %sspot%s %swatch%s\n'    "$pipe" "$reset" "$primary" "$reset" "$secondary" "$reset"
  ...
  case "$choice" in
    1) spotlight_setup_index_suppression ;;
    2) spotlight_add_exclusions ;;
    3) spotlight_clean_exclusions ;;
    4) spotlight_list_exclusions ;;
    5) spotlight_watch_exclusions ;;
    *) return 0 ;;
  esac
