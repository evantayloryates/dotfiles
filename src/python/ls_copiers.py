...
COLOR_CODES = {
    ...
    # Common combos (foreground only; style + color)
    'bold_black': ['\033[1;30m', '\033[0m'],
    'bold_red': ['\033[1;31m', '\033[0m'],
    'bold_green': ['\033[1;32m', '\033[0m'],
    'bold_yellow': ['\033[1;33m', '\033[0m'],
    'bold_blue': ['\033[1;34m', '\033[0m'],
    'bold_magenta': ['\033[1;35m', '\033[0m'],
    'bold_cyan': ['\033[1;36m', '\033[0m'],
    'bold_white': ['\033[1;37m', '\033[0m'],

    'dim_black': ['\033[2;30m', '\033[0m'],
    'dim_red': ['\033[2;31m', '\033[0m'],
    'dim_green': ['\033[2;32m', '\033[0m'],
    'dim_yellow': ['\033[2;33m', '\033[0m'],
    'dim_blue': ['\033[2;34m', '\033[0m'],
    'dim_magenta': ['\033[2;35m', '\033[0m'],
    'dim_cyan': ['\033[2;36m', '\033[0m'],
    'dim_white': ['\033[2;37m', '\033[0m'],

    'bold_bright_black': ['\033[1;90m', '\033[0m'],
    'bold_bright_red': ['\033[1;91m', '\033[0m'],
    'bold_bright_green': ['\033[1;92m', '\033[0m'],
    'bold_bright_yellow': ['\033[1;93m', '\033[0m'],
    'bold_bright_blue': ['\033[1;94m', '\033[0m'],
    'bold_bright_magenta': ['\033[1;95m', '\033[0m'],
    'bold_bright_cyan': ['\033[1;96m', '\033[0m'],
    'bold_bright_white': ['\033[1;97m', '\033[0m'],

    'dim_bright_black': ['\033[2;90m', '\033[0m'],
    'dim_bright_red': ['\033[2;91m', '\033[0m'],
    'dim_bright_green': ['\033[2;92m', '\033[0m'],
    'dim_bright_yellow': ['\033[2;93m', '\033[0m'],
    'dim_bright_blue': ['\033[2;94m', '\033[0m'],
    'dim_bright_magenta': ['\033[2;95m', '\033[0m'],
    'dim_bright_cyan': ['\033[2;96m', '\033[0m'],
    'dim_bright_white': ['\033[2;97m', '\033[0m'],
}
